...
# (氏名, 区分, 部屋, 入所日, 入所時刻, 退所日, 退所時刻, 状態, 送迎, 送迎方法, 場所, 備考)
BOOKINGS = [
    ("◎◎様",    "SS", "１Ｆ", datetime.date(2026,8,1),  "16:00", datetime.date(2026,8,2),  "09:00", "確定", "あり", "施設車", "自宅前 16:00", ""),
    ("木村様",    "SS", "１Ｆ", datetime.date(2026,8,5),  "16:30", datetime.date(2026,8,7),  "09:00", "確定", "なし", "", "", ""),
    ("◎◎様",    "SS", "１Ｆ", datetime.date(2026,8,8),  "10:00", datetime.date(2026,8,8),  "16:00", "確定", "あり", "家族送迎", "", "日帰り（体験利用）"),
    ("小澤様",    "SS", "１Ｆ", datetime.date(2026,8,14), "16:00", datetime.date(2026,8,16), "09:00", "確定", "調整中", "", "", ""),
...
wb["08_支給量管理"]["B3"] = MONTH
wb["07_月次集計"]["B3"] = MONTH
wb["07_月次集計"]["B4"] = datetime.date(2026, 8, 31)
